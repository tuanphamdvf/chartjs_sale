...
class VeryBasicView extends owl.Component {
    inputRef = useRef("myChart");
    inputRef2 = useRef("myChart2");
    inputRef3 = useRef("myChart3");
    month = useRef("month");
    staff = useRef("staff")
    state = {
        monthValue: "",
    ...
    async mounted() {
        this.listNewCustomer = await this.ormService.searchRead("res.partner", [['create_date', '>=', startOfMonth],
        ...
        this.listOrderLine = await this.ormService.searchRead("pos.order.line", [['create_date', '>=', startOfMonth],
        ['create_date', '<=', endOfMonth],]);
        ...
        this.listPurchase = await this.ormService.searchRead("purchase.order", [['create_date', '>=', startOfMonth],
        ...
        console.log('danh sách đơn hàng', arrayTotalPrice)



        var myChart = new Chart(this.inputRef.el, {
        ...
        var myDoughnutChart = new Chart(this.inputRef2.el, {
            type: 'doughnut',
            data: {
                labels: labelProduct,
                datasets: [{
        ...
        var myBarChart = new Chart(this.inputRef3.el, {
            type: 'bar',
    ...
    onClick() {
        ...
        this.state = {
            monthValue: this.month.el.value,
            staffValue: this.staff.el.value
        }
        const a = new Date(yearCurrent, 2 - 1, 1); // Ngày đầu tháng
        const b = new Date(yearCurrent, 2, 0); // Ngày cuối tháng
        this.state.endOfMonth = b
        this.state.startOfMonth = a
